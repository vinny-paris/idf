#ifndef IdfParser_hpp_INCLUDED
#define IdfParser_hpp_INCLUDED
...
public:
    ...
    std::string encode(std::vector<std::vector<std::string> > const &idf_list);

    enum class Token : size_t {
        NONE = 0, END = 1, EXCLAMATION = 2, COMMA = 3, SEMICOLON = 4, STRING = 5
    };
